...
public class Game extends JPanel {
    ...
    private static Font FONT_M = new Font("Consolas", Font.BOLD, 24);
    private static Font FONT_M_ITALIC = new Font("Consolas", Font.ITALIC, 24);
    private static Font FONT_L = new Font("Consolas", Font.PLAIN, 84);
    private static Font FONT_XL = new Font("Consolas", Font.PLAIN, 150);
    ...
    public Game() {
        ...
        setFocusable(true);
        setBackground(new Color(71, 205, 165));
